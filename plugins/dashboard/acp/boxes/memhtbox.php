...
<div class="ui-widget-content ui-corner-all dwidget">
	<div class="ui-widget-header">Featured</div>
	<div class="body"><iframe src="http://serv.memht.com/featured.php?ver=<?php echo $config_sys['engine_version']; ?>" scrolling="no" style="border:0;width:100%;height:162px;" frameborder="0"></iframe></div>
</div>