...
function template_header($step) {
	...
	<div class="tpl_bar">
		<div>
			<ul class="steps">
				...
				<li<?php if ($step==1) { echo " class='sel'"; } ?>>Requirements</li>
				<li<?php if ($step==2) { echo " class='sel'"; } ?>>Database data</li>
				<li<?php if ($step==3) { echo " class='sel'"; } ?>>Tables</li>
				<li<?php if ($step==4) { echo " class='sel'"; } ?>>Administrator</li>
				<li<?php if ($step==5) { echo " class='sel'"; } ?>>Finish</li>
			</ul>
        </div>
    </div>
	</div>
	...
	switch ($step) {
		...
		case 0: $message = "MemHT Portal is a free software released under the GNU/GPLv2 License by Miltenovikj Manojlo";
			break;
		case 1: $message = "Required and optional components that MemHT Portal needs";
			break;
		case 2: $message = "Database connection data";
			break;
		case 3: $message = "Database structure and simple data";
			break;
		case 4: $message = "Administrator's account data";
			break;
		case 5: $message = "Installation finished";
			break;
	}
	?>
