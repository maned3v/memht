...
require_once(_PATH_ACP_LIBRARIES._DS."MemHT"._DS."router.class.php"); //Site router [Ext,MVCACPRouter]
...
include_once(_PATH_ACP_LIBRARIES._DS."MemHT"._DS."template.class.php"); //Template engine
...
require_once(_PATH_ACP_INCLUDES._DS."layout.inc.php"); //Site layout structure
